export const basicTzList = [
  ...
  },
  {
    value: 'local',
    id: 'local',
    label: 'Lokale Zeitzone (Local)',
    subList: false
  },
  {
    value: 'other',
    id: 'other',
    label: 'Andere Zeitzone',
    subList: true
  }
]
...
export const otherList = [
  ...
  {
    value: 'Antarctica/DumontDUrville', // https://bugs.chromium.org/p/chromium/issues/detail?id=928068
    label: 'Antarctica/DumontDUrville' // https://bugs.chromium.org/p/chromium/issues/detail?id=928068
  },
  {
  ...
  {
    value: 'Asia/Qostanay', // https://bugs.chromium.org/p/chromium/issues/detail?id=928068
    label: 'Asia/Qostanay' // https://bugs.chromium.org/p/chromium/issues/detail?id=928068
  },
  {
    value: 'Asia/Aqtobe',
    label: 'Asia/Aqtobe'
...
export const otherTzList = sortOtherList(otherList)
